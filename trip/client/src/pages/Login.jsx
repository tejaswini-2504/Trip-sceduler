...
const Login = () => {
  ...
  return (
    <div className="mx-auto max-w-lg rounded-3xl border border-slate-800 bg-slate-900/90 p-8 shadow-2xl shadow-slate-950/20">
      ...
      <p className="mt-3 text-slate-400">Access your saved trips and personalized planner dashboard.</p>
      ...
      <p className="mt-6 text-sm text-slate-500">Don’t have an account? <span className="text-cyan-300 hover:text-cyan-200 cursor-pointer" onClick={() => navigate('/register')}>Register</span></p>
    </div>
  );
};
